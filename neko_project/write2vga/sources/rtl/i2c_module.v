...
//reg[16:0] divider = 0;//====================时钟
reg clk_div = 0;//CLK周期*256倍，clk_div_2周期*2倍，19.5KHZ
wire clk_div_2;//CLK周期*128倍，39KHZ
reg[7:0] divider2 = 0; 
...
assign clk_div_2 = divider2[7]; //CLK周期*128倍，39KHZ
//=================================================
...
always@(negedge clk_div_2) //状态机状态跳转，电平跳转，STATE_ADDRESS_START、STATE_ADDRESS_START_2是半个周期，其他是一个周期，跳转的时钟是clk_div == 0
begin
	if(reset_n == 0)
	begin
