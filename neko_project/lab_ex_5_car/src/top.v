...
//    output                      vga_out_de,
    ...
    output                      cam_scl      ,  //cmos SCCB_SCL 时钟
    inout                       cam_sda,        //cmos SCCB_SDA 数据
    input                       key_inc,
    input                       key_dec,
    input                       switch_param,
    input                       switch_step,
    output      [3:0]           slect_aw,
    output      [7:0]           a_data_outw
);
...
parameter  V_CMOS_DISP = 11'd768;                  //CMOS鍒嗚鲸鐜?-琛?
parameter  H_CMOS_DISP = 11'd1024;                 //CMOS鍒嗚鲸鐜?-鍒?
parameter  TOTAL_H_PIXEL = H_CMOS_DISP + 12'd1216; //CMOS鍒嗚鲸鐜?-琛?
...
assign slect_aw = 4'b1110;
assign a_data_outw = seg_decode(highlight_digit);
...
hdmi_tx #(.FAMILY("EG4"))	//EF2銆丒F3銆丒G4銆丄L3銆丳H1
