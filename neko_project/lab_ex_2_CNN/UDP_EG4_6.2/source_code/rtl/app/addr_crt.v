module addr_crt (
 ...
 output reg [12:0] wr_addr,  // Changed from [15:0] to [12:0] for 80x100 = 8000 pixels
 output reg       wr_en,
 output        rd_en,
...
reg flag;
reg [12:0] wr_addr_cnt;  // Changed from [15:0] to [12:0]
reg [2:0] cnt;
always @(posedge clk or negedge rst_n ) begin
    ...
    wr_addr_cnt<=0;
        wr_en<=0;
            ...
            begin
                wr_en<=1'b1;
                wr_addr[12:8]<=udp_data[4:0];  // Only use lower 5 bits for 13-bit address
            end
        else begin
                wr_en<=1'b0;
