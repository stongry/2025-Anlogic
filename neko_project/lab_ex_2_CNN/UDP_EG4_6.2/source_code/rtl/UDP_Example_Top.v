...
assign cam_xclk = clk_12_5_out;  // provide camera XCLK
assign slect_aw = 4'b1110;       // enable the first digit on the 7-seg display
assign a_data_outw = seg_decode(input_local_ip_address[3:0]);

function automatic [7:0] seg_decode(input [3:0] value);
    begin
        case (value)
            ...
            default: seg_decode = 8'b1100_0110;
        endcase
    end
endfunction
