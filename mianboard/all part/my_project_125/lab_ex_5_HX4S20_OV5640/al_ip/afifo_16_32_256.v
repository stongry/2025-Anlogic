 ...
 ** File	:	E:/projects/2023_10_10_HX4S20_test/spi_FLASH_SDRAM_pic/HX4S20/al_ip/afifo_16_32_256.v
 ** Date	:	2025 06 10
...
module wfifo_32_32_512 #(parameter DATA_WIDTH_W = 32, 
    ...
    fifo_cross_domain_addr_process_al_wfifo_32_32_512 #(.ADDR_WIDTH(ADDR_WIDTH_R)) rd_to_wr_cross_inst (.primary_asreset_i(rd_rst), 
    ...
    fifo_cross_domain_addr_process_al_wfifo_32_32_512 #(.ADDR_WIDTH(ADDR_WIDTH_W)) wr_to_rd_cross_inst (.primary_asreset_i(wr_rst), 
                .secondary_asreset_i(rd_rst), 
                .primary_clk_i(clkw), 
                .secondary_clk_i(clkr), 
                .primary_addr_i(wr_addr), 
                .secondary_addr_o(wr_to_rd_addr)) ; 
    ram_infer_wfifo_32_32_512 #(.DATAWIDTH_A(DATA_WIDTH_W),
...
`timescale 1ns/1ps
module fifo_cross_domain_addr_process_al_wfifo_32_32_512 #(parameter ADDR_WIDTH = 9) (
...
`timescale 1ns/1ps
module ram_infer_wfifo_32_32_512 (clka, 
        rsta, 
        cea, 
        ocea, 
        wea, 
