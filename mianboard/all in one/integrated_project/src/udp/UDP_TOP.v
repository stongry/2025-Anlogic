...
module UDP_TOP(
        ...
        //udp传输图像
        output			HDMI_CLK_P,
	    output			HDMI_APP_D2_P,
	    output			HDMI_APP_D1_P,
	    output			HDMI_APP_D0_P,
...
udp_loopback#(
 ...
 (
    ...
    `ifdef UDP_LOOP_BACK    
    .app_rx_data                (udp_data             ),
    .app_rx_data_valid          (Sdr_rd_en      ),
    .app_rx_data_length         (cam_data_length     ),
    `else   
...
hdmi_tx #(.FAMILY("EG4"))	//EF2、EF3、EG4、AL3、PH1
 ...
 u2_hdmi_tx
	(
        ...
        .HDMI_D2_P (HDMI_APP_D2_P ),  // <-- 修改这里
        .HDMI_D1_P (HDMI_APP_D1_P ),  // <-- 修改这里
        .HDMI_D0_P (HDMI_APP_D0_P )	  // <-- 修改这里
...
cam_data u_cam_data(
    ...
    .udp_data                  (udp_data           ),
    .udp_data_length           (cam_data_length    )
);
